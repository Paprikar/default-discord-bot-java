...
/**
 * The command for setting trusted suggesters variables.
 */
@Component
public class ConfigWizardTrustedSuggestersSetCommand implements ConfigWizardTrustedSuggestersCommand {

    private static final Logger logger = LoggerFactory.getLogger(ConfigWizardTrustedSuggestersSetCommand.class);
    ...
    private final Map<String, ConfigWizardTrustedSuggestersSetter> setters = new HashMap<>();
    ...
    public ConfigWizardTrustedSuggestersSetCommand(DiscordCategoryService categoryService,
                                                   List<ConfigWizardTrustedSuggestersSetter> setters) {
    ...
    public ConfigWizardState execute(@Nonnull PrivateMessageReceivedEvent event,
        ...
        ConfigWizardTrustedSuggestersSetter setter = setters.get(varName);
        if (setter == null) {
            session.getResponses().add(new EmbedBuilder()
                    .setColor(Color.RED)
                    .setTitle("Configuration Wizard Error")
